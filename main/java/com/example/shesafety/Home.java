...
public class Home extends AppCompatActivity implements GoogleApiClient.ConnectionCallbacks,
    ...
    CardView friend, map, emergency, call, flash;
    ArrayList<String> a;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        emergency = (CardView) findViewById(R.id.message);
        call = (CardView) findViewById(R.id.call);
        flash = (CardView) findViewById(R.id.siren);

       // siren = (CardView) findViewById(R.id.siren);
        //multimedia = (CardView) findViewById(R.id.multimedia);
       ...
       /* btn1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                startActivity(new Intent(getApplicationContext(), fakesiren.class));*/
